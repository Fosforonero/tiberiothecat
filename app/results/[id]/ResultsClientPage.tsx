...
const IT_COPY = {
  ...
  minorityDescIsolated: 'Sei davvero in minoranza. Quasi nessuno la pensa come te.',
  ...
  anonCTAHeadline:   'Vuoi seguire le tue scelte nel tempo?',
  ...
  personalityTeaser: '🧠 Si vede uno schema nelle tue scelte',
  personalityTeaserBody: 'Scopri la tua personalità morale — sei Guardian, Strategist o Empath?',
  ...
  moreShareSub:      'Instagram, TikTok, X, WhatsApp, Discord, Telegram, story card',
  expertInsightCTA:  'Leggi il parere dell\'esperto',
  ...
  comparing:         'Confrontiamo il tuo voto con il mondo…',
  noVotesYet:        'Non ci sono ancora abbastanza voti per mostrare un risultato.',
  voteThisTitle:     'Vota questo dilemma',
