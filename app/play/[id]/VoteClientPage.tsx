...
const EN_COPY = {
  ...
  revealHint:          'Vote to reveal how SplitVote voters split.',
...
const IT_COPY = {
  ...
  graceHint:           'Hai cambiato idea? Hai un attimo per cambiare prima che venga registrato.',
  graceUndo:           'Annulla',
  graceConfirm:        'Conferma subito',
  shareQuestion:       'Condividi domanda',
  shareQuestionCopied: 'Link copiato!',
  revealHint:          'Vota per scoprire come si dividono i votanti su SplitVote.',
  changeVote:          'Passa a questa',
